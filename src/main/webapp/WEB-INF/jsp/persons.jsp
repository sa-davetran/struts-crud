    ...
    <body>
        ...
        <table class="borderAll">
            <tr>
                ...
                <th><s:text name="person.petModels"/></th>
                <th>&nbsp;</th>
            </tr>
            <s:iterator value="persons" status="status">
                <tr class="<s:if test="#status.even">even</s:if><s:else>odd</s:else>">
                    ...
                    <td class="nowrap">
                        ...
                        %>
                        <s:if test="yearOfBirth != null">
                            <s:set var="age" value="%{#attr.currentYear - yearOfBirth}" />
                            <s:property value="#age"/>
                            <s:if test="%{#age >= 21}">
                                <span style="color:green; font-size: large; margin-left: 5px;">&#x2714;</span>
                            </s:if>
                            <s:else>
                                <span style="color:red; font-size: large; margin-left: 5px;">&#x2717;</span>
                            </s:else>
                        </s:if>
                        <s:else>
                            N/A
                    ...
                    <td class="nowrap">
                        <s:if test="carModels != null && carModels.length > 0">
                            <s:iterator value="carModels" status="carStatus">
                                <s:property value="model"/>
                                <s:if test="!#carStatus.last">, </s:if>
                            </s:iterator>
                        </s:if>
                    </td>
                    <td class="nowrap">
                        <s:if test="petModels != null && petModels.length > 0">
                            <s:iterator value="petModels" status="petStatus">
                                <s:property value="name"/>
                                <s:if test="!#petStatus.last">, </s:if>
                            </s:iterator>
                        </s:if>
                    </td>
                    <td class="nowrap">
